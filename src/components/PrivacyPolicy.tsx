		...
		<section className={styles.policy}>
			...
			<p>
				<p>
					...
					browser type and version, the pages you visit, the time and
					date of your visit, the time spent on each page, other
			...
			<p>
				...
				<p>
					...
					one can guarantee absolute data security. We will comply
			...
			<p>
				<p>
					...
					policy. If your personal information is no longer required,
					we will delete it or make it anonymous by removing all
			...
			<p>
				<p>
					...
					website may be affected. We will not discriminate against
					you for exercising any of your rights over your personal
					information. If you do provide us with personal information
					you understand that we will collect, hold, use and disclose
					it in accordance with this privacy policy. You retain the
					right to request details of any personal information we hold
					about you.
				</p>
				<p>
				...
				<p>
					...
					your mind at any time. We will provide you with the ability
